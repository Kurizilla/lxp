...
-- CreateEnum
CREATE TYPE "m01_classroom_role" AS ENUM ('STUDENT', 'TEACHER', 'ASSISTANT', 'ADMINISTRATOR');
...
CREATE TABLE "m01_user_classrooms" (
    ...
    "role" "m01_classroom_role" NOT NULL DEFAULT 'STUDENT',
...
-- CreateIndex
CREATE INDEX "announcements_creator_id_idx" ON "announcements"("creator_id");
...
-- CreateIndex
CREATE INDEX "m01_subjects_establishment_id_idx" ON "m01_subjects"("establishment_id");

-- CreateIndex
CREATE INDEX "m01_subjects_is_active_idx" ON "m01_subjects"("is_active");

-- CreateIndex
CREATE UNIQUE INDEX "m01_subjects_establishment_id_code_key" ON "m01_subjects"("establishment_id", "code");
...
-- CreateIndex
CREATE INDEX "m01_user_classrooms_role_idx" ON "m01_user_classrooms"("role");
...
-- AddForeignKey
ALTER TABLE "m01_subjects" ADD CONSTRAINT "m01_subjects_establishment_id_fkey" FOREIGN KEY ("establishment_id") REFERENCES "m01_establishments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "m01_classrooms" ADD CONSTRAINT "m01_classrooms_subject_id_fkey" FOREIGN KEY ("subject_id") REFERENCES "m01_subjects"("id") ON DELETE SET NULL ON UPDATE CASCADE;
